...
public class Executor {
    ...
    protected ConnectionFind connection;
    private Sql sql;

    public Executor(ConnectionFind connection, Sql sql) {
    ...
    private PreparedStatement getStatement(int autoGeneratedKeys) throws SQLException {
        PreparedStatement statement = connection.get().prepareStatement(sql.getSql(), autoGeneratedKeys);
